...
const Contact = () => {
  return (
    <section className="h-screen bg-fuchsia-100 pt-[30px] md:pt-10">
      ...
      <div className="mt-[68px] px-5 sm:mt-[100px] grid grid-cols-1 sm:grid-cols-2 gap-y-[50px] sm:gap-x-[50px]">
        <h4 className="font-[600] text-[20px] sm:text-2xl md:text-[45px] md:leading-[50px]">
